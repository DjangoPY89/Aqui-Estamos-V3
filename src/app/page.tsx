...
export default function HomePage() {
  const jsonLd = {
    ...
    "description": "Empresa líder de servicio de limpieza a domicilio, casas, departamentos, oficinas y empresas en Asunción y Gran Asunción Paraguay. Personal calificado e inscripto formalmente en IPS.",
