  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white/95 backdrop-blur-2xl rounded-[32px] max-w-lg w-full p-6 sm:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-white/60 relative my-8 space-y-5"
      >
