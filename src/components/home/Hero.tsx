      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-28 lg:py-36 flex flex-col justify-center">
        <div className="max-w-3xl space-y-6 sm:space-y-8 animate-in fade-in duration-500">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-neutral-950 tracking-tight leading-[1.12]">
            ...
            <span className="text-electric-600 drop-shadow-xs font-black">
              hogar.
            </span>
          </h1>

          {/* Bajada en Color Negro */}
          <p className="text-base sm:text-lg lg:text-xl text-neutral-950 leading-relaxed font-semibold sm:font-medium max-w-2xl">
          ...
          <div className="pt-6 sm:pt-8 border-t border-neutral-300/90 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-left">
            <div className="flex items-center sm:block gap-3">
              ...
              <p className="text-xs text-neutral-900 font-semibold mt-0.5">Google Reviews (+1.5k servicios)</p>
            </div>
            ...
            <div className="flex items-center sm:block gap-3">
              ...
              <p className="text-xs text-neutral-900 font-semibold mt-0.5">Inscripción formal en IPS</p>
            </div>
            ...
            <div className="flex items-center sm:block gap-3">
              ...
              <p className="text-xs text-neutral-900 font-semibold mt-0.5">Satisfacción asegurada</p>
            </div>
          </div>
