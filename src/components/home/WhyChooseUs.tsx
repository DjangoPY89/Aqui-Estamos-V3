...
import { Sparkles, ShieldCheck, UserCheck, Award, Wallet, Heart } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-neutral-900 tracking-tight leading-tight flex items-center justify-center gap-3 flex-wrap">
            <span>¿Por qué elegir Aquí Estamos?</span>
            <span className="inline-flex p-1.5 rounded-xl bg-pink-50 text-pink-500 border border-pink-100">
              <Heart className="w-6 h-6 sm:w-8 sm:h-8 fill-pink-500 text-pink-500" />
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((p, idx) => {
            ...
            return (
              ...
              >
                <div>
                  <div className={`w-12 h-12 rounded-2xl ${p.iconBg} border flex items-center justify-center mb-5 shadow-xs group-hover:scale-110 transition-transform`}>
